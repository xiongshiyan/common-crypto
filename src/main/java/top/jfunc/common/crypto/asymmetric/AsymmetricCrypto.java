...
import top.jfunc.common.crypto.KeyGenerator;
import top.jfunc.common.crypto.symmetric.Base64;
import top.jfunc.common.crypto.symmetric.SymmetricAlgorithm;
...
public class AsymmetricCrypto implements Crypto {
	...
	/**
	 * 构造，创建新的私钥公钥对
	 * @param algorithm {@link top.jfunc.common.crypto.symmetric.SymmetricCrypto}
	 */
