...
import top.jfunc.common.crypto.digest.*;
import top.jfunc.common.crypto.symmetric.*;
...
public class CryptoTest {
    ...
    public void testStream() throws Exception{
        ...
        FileInputStream in = new FileInputStream("C:\\Users\\xiongshiyan\\Desktop\\1.txt");//"熊诗言" -> 1.txt
        FileOutputStream out = new FileOutputStream("C:\\Users\\xiongshiyan\\Desktop\\2.bat");
        crypto.encrypt(in,out);

        String encrypt = crypto.encrypt("熊诗言");
